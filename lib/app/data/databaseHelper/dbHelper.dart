...
import '../hadiths_model.dart';

const String tableNameNotes = 'hadiths';

class HadithsDatabase {
  static final HadithsDatabase instance = HadithsDatabase._init();

  static Database? _database;

  HadithsDatabase._init();

  Future<Database> get database async {
    if (_database != null) return _database!;

    _database = await _initDB('hadiths.db');
    return _database!;
  }
